 ...
 *
 */
public class Test_JavaFilePathFinderTest {

	private static String BASEDIR = "C:\\Users\\Jaydon\\git\\SENG-300-Group-Project-Iteration-1-1\\SENG-300-Group-Project-Iteration-1\\test";
	...
	public void allFilesJava(){
			...
			String str;
			str = BASEDIR + File.separator + "GoodExtensions";
	...
	public void someFilesJava(){
			...
			String str;
			str = BASEDIR + File.separator + "MixExtensions";
			String[] results = pathFinder.getJavaFiles(str);
	...
	public void NoFilesJava(){
			...
			String str;
			str = BASEDIR + File.separator + "BadExtensions";
			String[] results = pathFinder.getJavaFiles(str);
